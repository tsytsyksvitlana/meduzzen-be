from web_app.exceptions.users import UserAlreadyExistsException
...
class UserService:
    ...
    async def get_users(self, offset: int, limit: int):
        users = await self.user_repository.get_users(offset, limit)
    ...
    async def update_user(self, user_id: int, user_update: UserUpdateRequestModel) -> User:
